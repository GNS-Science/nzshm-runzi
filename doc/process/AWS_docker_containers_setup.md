...
```
#EG
export FATJAR_TAG=mfd_unc_units #153-reweighting-alpha1 #low-stddev-alpha4-1e20 #low-stddev-alpha3
...
```
export RUNZI_GITREF=d3e6137
export IMAGE_ID=14885acd5b40 #from docker build
