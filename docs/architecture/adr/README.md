...
| [0012](0012-openquake-cores-from-ecs-vcpu.md) | OpenQuake core cap derived from `ecs_vcpu`, not the Java thread arg |
| [0013](0013-opensha-provenance-from-jar-resources.md) | OpenSHA build provenance rides on jar resources, not a runtime git checkout |
