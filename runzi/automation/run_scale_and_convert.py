...
if __name__ == "__main__":
    ...
    if task == 'test all':
        ...
        model_type = ModelType.SUBDUCTION
        source_solution_ids = [
            "U2NhbGVkSW52ZXJzaW9uU29sdXRpb246MTAwNjU3",
            "U2NhbGVkSW52ZXJzaW9uU29sdXRpb246MTAwNjU2"
        ]   
    ...
    if scale:
        scale_gt_id = scale_solution.run(source_solution_ids, scales,model_type, 
    ...
    convert_gt_id = convert_solution.run(scaled_solution_ids, model_type,
                                        task_title, TASK_DESCRIPTION, WORKER_POOL_SIZE)
