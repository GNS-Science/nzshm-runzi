...
class BuilderTask:
    ...
    def run(self, task_arguments, job_arguments):
        ...
        self._page_gen.setRuptureSet(ta['rupture_set_file_path']).setName(report_title).setOutputPath(
            str(diags_folder)
        ).setPlotLevel(ja['build_report_level']).setFillSurfaces(True).generateRupSetPage()
