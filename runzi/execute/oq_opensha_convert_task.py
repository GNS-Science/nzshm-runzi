    ...
    def run(self, task_arguments, job_arguments):
        ...
        def convert(config):
            ...
            computed = get_multi_fault_source(
                src_folder, dip_sd, strike_sd, source_id, source_name, tectonic_region_type, investigation_time, prefix
            )
            ...
            write_source_model(
                out_file, [computed], name=source_name, investigation_time=investigation_time, prefix=prefix
            )
