        ...
        for b_and_n in args['b_and_n']:
            for rid, rupture_set_info in rupture_sets.items():
                for (
                    ...
                    args['mfd_equality_weights'],
                    args['mfd_inequality_weights'],
                    args['slip_rate_weighting_types'],
                    ...
                    args['threads_per_selectors'],
                    args['averaging_threads'],
                    args['averaging_interval_secs'],
                    args['non_negativity_functions'],
                    args['perturbation_functions'],
                    args['mfd_uncertainty_weights'],
                    args['mfd_uncertainty_powers'],
                    ...
                    if CLUSTER_MODE == EnvMode['AWS']:
                        ...
                        yield get_ecs_job_config(
                            ...
                            time_minutes=int(max_inversion_time),
                            memory=30720,
                            vcpu=4,
                        )
