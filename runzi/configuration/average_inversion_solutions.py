...
def build_average_tasks(
    general_task_id: str, task_type: SubtaskType, model_type: ModelType, subtask_arguments, toshi_api: ToshiApi
):
    ...
    for source_solution_ids in subtask_arguments['source_solution_groups']:
        ...
        task_arguments = dict(model_type=model_type.name)
        job_arguments = dict(
            task_id=task_count,
