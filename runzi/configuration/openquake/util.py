...
EC2_CONFIGS = {
    "BL_CONF_0": dict(
        job_def="BigLever_32GB_8VCPU_JD",
        job_queue="BigLever_32GB_8VCPU_JQ",
        mem=30000, cpu=8
    ),
    "BL_CONF_1": dict(
        job_def="BigLever_32GB_8VCPU_v2_JD",
        job_queue="BigLever_32GB_8VCPU_v2_JQ",
        mem=30000, cpu=8
    ),
    "BL_CONF_2": dict(
        job_def="BigLever_32GB_8VCPU_v2_JD",
        job_queue="BigLever_16GB_4VCPU_JQ",
        mem=15000, cpu=4
    ),
