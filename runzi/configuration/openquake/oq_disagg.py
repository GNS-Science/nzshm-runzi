...
def get_loc_vs30(job_config: 'OQDisaggArgs') -> Generator[LocVs30, None, None]:
...
def build_disagg_tasks(subtask_type: SubtaskType, model_type: ModelType, disagg_config: 'OQDisaggArgs'):
