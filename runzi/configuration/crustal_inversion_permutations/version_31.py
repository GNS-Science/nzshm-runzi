...
def branch_permutations_generator_31(args, rupture_set_info):
    """
...
if __name__ == '__main__':
    ...
    constraint_wts = [
        {
            "tag": "UCT Mpow(0.25)_S(0,0)_Psmth(3)",
            "reweight": True,
            "mfd_pow": 0.15,
            "sr_scaling": 0,
            "sr_use_scaling": 0,
        ...
        {
            "tag": "UCT Mpow(0.5)_S(3,0,0)_Psmth(3,3)",
            "reweight": True,
            "mfd_pow": 0.25,
            "sr_scaling": 1,
            "sr_use_scaling": 1,
    ...
    count = 0
    for p in branch_permutations_generator_31(args, rupture_set_info):
        print(p)
        count += 1
