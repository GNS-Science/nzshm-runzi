...
if __name__ == '__main__':
    ...
    #1840-2020 options
    b_and_n_1840_to_2020 = [
            dict(tag="1840-2020 med", b_sans=0.9, N_sans=4.2, b_tvz=1.2, N_tvz=0.7),
            dict(tag="1840-2020 low", b_sans=0.8, N_sans=2.6, b_tvz=0.98, N_tvz=0.4),
            dict(tag="1840-2020 high", b_sans=1.0, N_sans=6.6, b_tvz=1.34, N_tvz=1.2),
    ]
    ...
    args = dict(
        ...
        initial_solution_ids = [
            "SW52ZXJzaW9uU29sdXRpb246MTcyNjAuMFJNd2FK",
        ],

        scaling_c = scaling_c,

        b_and_n = b_and_n_1840_to_2020,
        ...
        slip_rate_unnormalized_weights = ['1e5'],
        ...
        #Paleo
        paleo_rate_constraint_weights=[1e2, 1e3],
        paleo_rate_constraints = ["GEOLOGIC_SLIP_1_0"],

        paleo_probability_models = ["UCERF3", "UCERF3_PLUS_PT5"],
        paleo_parent_rate_smoothness_constraint_weights = [1e4, 0]
        )
    ...
    count = 0
    for p in branch_permutations_generator(args, rupture_set_info):
        # print(p)
        count +=1
