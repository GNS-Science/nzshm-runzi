                    ...
                    in itertools.product(
                        ...
                        args['cooling_schedules']
                            ...
                            task_arguments = dict(
                                ...
                                seismogenic_min_mag_tvz=seismogenic_min_mag['TVZ'],
                                seismogenic_min_mag_sans=seismogenic_min_mag['sansTVZ'],
                                max_mag_tvz=max_mag['TVZ'],
                                max_mag_sans=max_mag['sansTVZ'],
                                mfd_mag_gt_5_sans=mfd_mag_gt_5_sans,
                                mfd_mag_gt_5_tvz=mfd_mag_gt_5_tvz,
                                mfd_b_value_sans=mfd_b_value_sans,
                                mfd_b_value_tvz=mfd_b_value_tvz,
...
if __name__ == '__main__':
    ...
    b_and_n = [
        ...
        # {"tag": "1840-2020 high", "b_sans": 1.0, "N_sans": 6.6, "b_tvz": 1.34, "N_tvz": 1.2},
        # {"tag": "1840-1889 med", "b_sans": 0.9, "N_sans": 7.0, "b_tvz": 1.2, "N_tvz": 0.7},
        # {"tag": "1840-1889 low", "b_sans": 0.8, "N_sans": 4.2, "b_tvz": 0.98, "N_tvz": 0.4},
        # {"tag": "1840-1889 high", "b_sans": 1.0, "N_sans": 12.1, "b_tvz": 1.34, "N_tvz": 1.2},
        # {"tag": "1965-2008 med", "b_sans": 0.9, "N_sans": 1.3, "b_tvz": 1.2, "N_tvz": 1.1},
        # {"tag": "1965-2008 low", "b_sans": 0.8, "N_sans": 1.3, "b_tvz": 0.98, "N_tvz": 1.1},
        # {"tag": "1965-2008 high", "b_sans": 1.0, "N_sans": 1.3, "b_tvz": 1.34, "N_tvz": 1.1}
    ]
    ...
    count = 0
    for p in branch_permutations_generator_24(args, rupture_set_info):
        print(p)
        #assert 0
        count +=1
